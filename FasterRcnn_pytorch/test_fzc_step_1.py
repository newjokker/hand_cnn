...
def args_parse():
    ...
    ap.add_argument("-am", "--model", default=r"./diy_fas_2.pth", help="")
...
if __name__ == "__main__":
    ...
    """
    * python3 test.py -am ./models/model.pth -if ./imgs --gpuID 2 -save ./res
    """
    ...
    # 颜色表
    color_dict = {"fzc_yt":[0,0,255], "fzc_sm":[0,0,255], "fzc_gt":[0,0,255]}
    # ----------------------------------------------------------------------------------------------------------------------
